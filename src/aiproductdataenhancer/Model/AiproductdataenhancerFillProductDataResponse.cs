...
namespace aiproductdataenhancer.Model
{
    ...
    public partial class AiproductdataenhancerFillProductDataResponse : IValidatableObject
    {
        ...
        public AiproductdataenhancerFillProductDataResponse(Dictionary<string, string> productDataFilled = default(Dictionary<string, string>), float confidenceRate = default(float), float completionRate = default(float))
        {
